 ...
 * @module app/dashboard/p/[projectId]/crm/[visitorId]/page
 */
"use client";
...
/** Page props */
interface PageProps {
  /** Route parameters containing the visitor ID */
...
export default function CrmVisitorDetailPage({ params }: PageProps) {
  ...
  /**
   * Fetches visitor detail and reps from the API.
   */
    ...
    return (
      <Card className="border-destructive">
        <CardContent className="py-8 text-center">
          ...
          <Link
            href={`/dashboard/p/${projectId}/crm`}
