  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">What is hooman.live?</h2>
        <p className="text-muted-foreground">
          hooman.live is an embeddable widget that enables real-time video calls between
