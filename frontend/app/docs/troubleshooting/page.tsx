      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            ...
            <li>
              <strong>Check the console:</strong> Open Developer Tools and look for errors containing &quot;hooman.live&quot;
            </li>
            <li>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <li>
              <strong>Server unavailable:</strong> The hooman.live server may be temporarily unavailable
            </li>
          </ul>
        </div>
      </section>
