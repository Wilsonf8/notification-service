    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Add hooman.live to your website using a no-code platform. No
        ...
        <TabsContent value="squarespace" className="mt-6 space-y-8">
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Add hooman.live to your Squarespace site using Code Injection.
            </p>
          </section>
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-medium">
              Step 2: Add the hooman.live Script
            </h3>
            <p className="text-muted-foreground">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              with your hooman.live domain and{" "}
              <code className="bg-muted px-1.5 py-0.5 text-xs">
                lck_YOUR_EMBED_KEY
              </code>{" "}
              with your embed key from the hooman.live dashboard.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              ...
              <li>
                Look for the hooman.live widget button in the corner of your
                page
              </li>
  ...
  return (
    <div className="flex flex-col items-center justify-center border border-dashed border-border py-16">
      ...
      <p className="mt-4 text-sm text-muted-foreground">
        ...
        the site header or footer, and paste the hooman.live script tag there.
      </p>
    </div>
  );
}
