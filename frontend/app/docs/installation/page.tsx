        ...
        <TabsContent value="nextjs" className="mt-6 space-y-8">
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Add hooman.live to your Next.js application using the Script component
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Add the hooman.live script to your root layout file. Using{" "}
          ...
          <section className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              ...
              <li>Visit your website and look for the hooman.live widget in the corner</li>
